require("guan.lib.globalpatches")({cli = true})

math.randomseed() -- Generate PRNG seed

local pl_app = require "pl.lapp"
local log = require "guan.cmd.utils.logger"
...
return function(args)
  ...
  local cmd = require("guan.cmd." .. cmd_name)
  ...
  -- log.verbose("guan: %s", _guan._VERSION)
